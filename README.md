...
### Description
Chat-Linux-Gguf is the Ubuntu version of [Chat-Gradio-Gguf](https://github.com/wiseman-timelord/Chat-Windows-Gguf) (which runs on Windows). So, the plan for the differences are...
